...
![third](https://github.com/user-attachments/assets/2bd01f21-6787-45ef-bfeb-fc802590a5cf)
...
## Credits
PyIntruder CLI (2025) is designed and developed by Sagnik Haldar (hsagnik), Swarup Natukula, Nandan Gupta and Mohd Arif(Zero0x00) as a complete CLI redesign of the original ![PyIntruder](https://github.com/Yash114Bansal/PyIntruder), which was created by Yash Bansal and Sagnik Haldar in 2021.
